...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_POST['qdate']) && !empty($_POST['qnumber'])) {
            ...
            $sql = "insert into tbl_queue(qdate, qnumber, pid ) values (:qdate, :qnumber, :pid )";
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4"> <br>
                <h3>ฟอร์มเพิ่มข้อมูลคนไข้</h3>
                <form  action="addQueue.php" method="POST" >

            <input type="date" placeholder="วันที่เข้ารับการรักษา" name="qdate"> 
            <br> <br>
            <input type="number" placeholder="หมายเลขคิว" name="qnumber">
            <br> <br>
